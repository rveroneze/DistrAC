...
# Load datasets
data_name, X_train, X_test, y_train, y_test, _ = my_utils.get_data_uci(id_uci, encoder='no', seed=seed, X_to_numpy=False)
...
for chave in results[0].keys():
    ...
    for i, res in enumerate(results):
        ...
        # Load data of site 1
        idxs = stratified_partitions[i][1]
