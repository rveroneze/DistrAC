...
### Set these values:
FBASE_RINCLOSE = '/Documents/AIDE_rinclose_niid_qs/'
...
FBASE_RINCLOSE = FBASE_RINCLOSE + aux
...
_, X_train, _, y_train, _, classes = my_utils.get_data_uci(id_uci, encoder='no', seed=seed, X_to_numpy=False, stratify=True)
